...
from api.handlers import  teacher_router, building_router, cabinet_router, session_type_router, speciality_router, plan_router, semester_router, chapter_router, \
