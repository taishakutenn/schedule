...
from db.models import Certification, Teacher, Group, Cabinet, Building, Speciality, Session, TeacherCategory, SessionType, Semester, Plan, Chapter, Cycle, Module, SubjectsInCycle, SubjectsInCycleHours
