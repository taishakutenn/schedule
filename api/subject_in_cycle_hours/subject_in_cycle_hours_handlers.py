...
from api.subject_in_cycle_hours.subject_in_cycle_hours_services import SubjectInCycleHoursService

subject_in_cycle_hours_router = APIRouter()

subject_in_cycle_service_hours = SubjectInCycleHoursService()
...
async def create_subject_in_cycle_hours(body: CreateSubjectsInCycleHours, request: Request, db: AsyncSession = Depends(get_db)):
    return await subject_in_cycle_service_hours._create_new_subject_in_cycle_hours(body, request, db)
...
async def get_subject_in_cycle_hours_by_id(hours_id: int, request: Request, db: AsyncSession = Depends(get_db)):
    return await subject_in_cycle_service_hours._get_subject_in_cycle_hours_by_id(hours_id, request, db)
...
async def get_subjects_in_cycle_hours_by_subject_in_cycle(subject_in_cycle_id: int, query_param: Annotated[QueryParams, Depends()], request: Request, db: AsyncSession = Depends(get_db)):
    return await subject_in_cycle_service_hours._get_subjects_in_cycle_hours_by_subject_in_cycle(subject_in_cycle_id, query_param.page, query_param.limit, request, db)
...
async def get_subjects_in_cycle_hours_by_subject_and_semester(subject_in_cycle_id: int, semester: int, request: Request, db: AsyncSession = Depends(get_db)):
    return await subject_in_cycle_service_hours._get_subjects_in_cycle_hours_by_subject_and_semester(subject_in_cycle_id, semester, request, db)
...
async def get_all_subjects_in_cycle_hours(query_param: Annotated[QueryParams, Depends()], request: Request, db: AsyncSession = Depends(get_db)):
    return await subject_in_cycle_service_hours._get_all_subjects_in_cycle_hours(query_param.page, query_param.limit, request, db)
...
async def delete_subject_in_cycle_hours(hours_id: int, request: Request, db: AsyncSession = Depends(get_db)):
    return await subject_in_cycle_service_hours._delete_subject_in_cycle_hours(hours_id, request, db)
...
async def update_subject_in_cycle_hours(body: UpdateSubjectsInCycleHours, request: Request, db: AsyncSession = Depends(get_db)):
    return await subject_in_cycle_service_hours._update_subject_in_cycle_hours(body, request, db)